...
from prox_learning.skin_sanity.cvae.dataset import load_all, ProxCVAEDataset
from prox_learning.skin_sanity.cvae.model import CondVAE, elbo_loss

DEFAULT_GLOB = '/home/jaydv/code/molmo/resources/experiment_output/datagen/skin_pick_fixed_v1/FrankaSkinPickConfig/*/house_*/trajectories_batch_*.h5'
...
def main():
    ...
    ap.add_argument('--out', default='/home/jaydv/code/skin_sanity/cvae/runs/v1')
