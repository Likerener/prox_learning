...
Reads `skin_pick_fixed_v1/.../trajectories_batch_*.h5` and writes:
  - cvae/runs/v3/plots_data/dataset_overview.png
  - cvae/runs/v3/plots_data/per_patch_stats.png
  - cvae/runs/v3/plots_data/per_patch_depth_hist.png
  - cvae/runs/v3/plots_data/depth_vs_phase.png
  - cvae/runs/v3/plots_data/correlation_state_depth.png  (new: qpos/tcp vs fracNear)
"""
...
OUT = Path('/home/jaydv/code/skin_sanity/cvae/runs/v3/plots_data')
OUT.mkdir(parents=True, exist_ok=True)
ZFAR = 4.0
GLOB = '/home/jaydv/code/molmo/resources/experiment_output/datagen/skin_pick_fixed_v1/FrankaSkinPickConfig/*/house_*/trajectories_batch_*.h5'
