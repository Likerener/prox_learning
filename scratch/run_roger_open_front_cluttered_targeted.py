...
def main():
    ...
    # Target houses from smoke5: 9 and 11 looked best for link5_sensor_3.
    # Include 0,3,7 as controls because they were successful too.
    cfg.task_sampler_config.house_inds = [9, 11, 0, 3, 7]
    ...
    cfg.output_dir = (
        Path("assets/datagen")
        / "roger_open_front_cluttered_targeted"
        / "FrankaSkinOpenFrontClutteredReachPickAndPlacePilotConfig"
        / run_id
    )
    ...
    CustomParallelRolloutRunner.target_successes = 10
