...
def main():
    ...
    cfg = FrankaSkinHybridPnP5Config()

    cfg.num_workers = 1
    cfg.seed = 2026
    cfg.use_wandb = False

    # Small smoke run first, before any larger training/data run.
    cfg.task_sampler_config.house_inds = list(range(1))
    cfg.task_sampler_config.samples_per_house = 2
