...
print("IMPORTED ParallelRolloutRunner", flush=True)
...
def main():
    ...
    cfg.task_sampler_config.max_allowed_sequential_task_sampler_failures = 200
    cfg.task_sampler_config.max_allowed_sequential_rollout_failures = 200
    ...
    cfg.task_sampler_config.max_asset_failures = 1000
    ...
    cfg.output_dir = (
        Path("assets/datagen")
        / "roger_open_front_house9_test1_simple"
        / "FrankaSkinOpenFrontClutteredReachPickAndPlacePilotConfig"
        / run_id
    )
