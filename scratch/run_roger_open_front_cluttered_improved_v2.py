...
def main():
    ...
    # Improve environment by focusing on promising houses,
    # but DO NOT narrow pickup_types because house_9 only had 1 valid candidate after filtering.
    cfg.task_sampler_config.house_inds = [9, 11]
    cfg.task_sampler_config.samples_per_house = 5

    # Keep default pickup_types and default source_surface_types from the config.
    ...
    cfg.output_dir = (
        Path("assets/datagen")
        / "roger_open_front_cluttered_improved_v2_h9_h11_default_objects"
        / "FrankaSkinOpenFrontClutteredReachPickAndPlacePilotConfig"
        / run_id
    )
