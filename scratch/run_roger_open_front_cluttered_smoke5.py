...
def main():
    ...
    # Start small. This config defaults to 300 houses, but we only need a smoke test.
    ...
    cfg.output_dir = (
        Path("assets/datagen")
        / "roger_open_front_cluttered_smoke5"
        / "FrankaSkinOpenFrontClutteredReachPickAndPlacePilotConfig"
        / run_id
    )
    ...
    CustomParallelRolloutRunner.target_successes = 5
