...
results = run_evaluation(
    ...
    output_dir=Path("eval_output/ACTMolmoRollout_1ep_top_temporalagg_nofixed"),
    num_workers=1,
    use_wandb=False,
...
out = Path("/home/qinzhengfangli/act/ckpt_molmo_wandb_1000ep/rollout_eval_1ep_top_temporalagg_nofixed.json")
