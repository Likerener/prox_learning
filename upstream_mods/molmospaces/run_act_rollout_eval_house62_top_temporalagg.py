...
dummy_config.policy_config.checkpoint_path = "/home/qinzhengfangli/act/ckpt_molmo_chunk20_bs64_100ep_gripperfix/policy_best.ckpt"
...
results = run_evaluation(
    ...
    checkpoint_path="/home/qinzhengfangli/act/ckpt_molmo_chunk20_bs64_100ep_gripperfix/policy_best.ckpt",
    task_horizon_steps=600,
    output_dir=Path("eval_output/ACTMolmoRollout_house62_top_temporalagg_gripperfix100ep_h300"),
    num_workers=1,
    use_wandb=False,
...
summary = {
    ...
    "note": "Top-camera aligned ACT rollout with temporal aggregation. Intended quick smoke test on first available benchmark episode."
}

print(json.dumps(summary, indent=2))

out = Path("/home/qinzhengfangli/act/ckpt_molmo_chunk20_bs64_100ep_gripperfix/rollout_eval_house62_top_temporalagg_h300.json")
