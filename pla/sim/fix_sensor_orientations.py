...
URDF_IN = Path(os.environ.get(
    'PLA_URDF_IN', str(REPO_ROOT / 'assets/urdf/fr3_full_skin.urdf')))
URDF_OUT = Path(os.environ.get(
    'PLA_URDF_OUT', str(REPO_ROOT / 'assets/urdf/fr3_full_skin_fixed.urdf')))
SKIN_MESH_DIR = Path(os.environ.get(
    'PLA_SKIN_MESH_DIR',
    str(REPO_ROOT / 'assets/meshes/skin_meshes'),
))
REPORT = Path(os.environ.get(
    'PLA_SENSOR_FIX_REPORT', str(REPO_ROOT / 'reports/logs/sensor_fix_report.txt')))
