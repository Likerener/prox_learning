...
Outputs (saved to OUT_DIR, defaults to repo's reports/checks/replay_traj0/)
...
H5_DEFAULT    = os.environ.get(
    'PLA_PROX_H5',
    str(REPO_ROOT / 'data/skin_pick_fixed_v1/house_0/trajectories_batch_1_of_1.h5'),
)
MJCF_DEFAULT  = os.environ.get(
    'PLA_MJCF',
    str(REPO_ROOT / 'assets/mjcf/fr3_skin.xml'),
)
OUT_DEFAULT   = str(REPO_ROOT / 'reports/checks/replay_traj0')
